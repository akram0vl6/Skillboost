export const roadmaps = [
    { id: 1, name: "Python", path: "python", title: "Один из самых популярных языков программирования. Легок в изучении и прост в применении.", img: "./img/tehnalogi/python.svg", roadmap: "../src/assets/img/Python.png" },
