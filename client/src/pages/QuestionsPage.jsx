...
function QuestionsPage() {
  ...
  // получаем вопросы по tech
  // const questions = getQuestionsByTech(tech); // твоя функция или API-запрос
    ...
    <div>
      ...
      <div className="flex flex-col gap-2 mt-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="rounded-2xl p-1 px-3 text-md text-[var(--color-text)] bg-[var(--bg-03)] cursor-pointer hover:bg-[var(--bg-02)] flex gap-1 items-center transition-colors">
            <span>Стажёр</span>
          </div>
          <div className="rounded-2xl p-1 px-3 text-md text-[var(--color-text)] bg-[var(--bg-03)] cursor-pointer hover:bg-[var(--bg-02)] flex gap-1 items-center transition-colors">
            <span>Junior</span>
      ...
      <div>
        ...
        <section className="scroll-my-[75px] shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.1),_0_10px_15px_-3px_rgba(0,0,0,0.1)] dark:shadow-none dark:border dark:border-surface-500 w-full py-2 px-4 rounded-2xl">
          <section className="relative w-full">
            <section className="flex flex-col gap-3 pt-4 pb-2">
                  ...
                  <section className="flex items-center gap-2 relative support-selectable">
                    <section>
                      <h2 className="font-normal">
                        Какие существуют особенности в работе примитивных типов
                        данных?
                      </h2>
                    </section>
                  </section>
              ...
              {/* <section className="support-selectable">
        <section className="quill-styles overflow-auto">
          <p>Какие существуют особенности в работе примитивных типов данных?</p>
        </section>
      </section> */}
                ...
                <section className="w-full">
                  ...
                  >
                    ...
                    <svg
                      ...
                      aria-hidden="true"
                      role="img"
                      className="transition-transform -mb-1 iconify iconify--st-icons"
                      width="1em"
                      height="1em"
                      viewBox="0 0 24 24"
                      style={{ fontSize: "16px" }}
